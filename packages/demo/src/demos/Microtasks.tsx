        ...
        <div className="flex items-start gap-2">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-yellow-800 mb-2">
              Only ELITE tier users (1600+ score) can post tasks. This ensures:
            </p>
            <ul className="text-sm text-yellow-800 space-y-1">
              ...
              <li className="flex items-center gap-2">
                <span>OK</span>
                <span>Trusted posters with proven track record</span>
              </li>
              <li className="flex items-center gap-2">
                <span>OK</span>
          ...
          <>
            <div className="mb-4">
              ...
              <ul className="space-y-2 text-sm">
                <li className="flex items-center gap-2">
                  <span className={score >= 1600 ? "text-green-500" : "text-red-500"}>
                    {score >= 1600 ? "OK" : "NO"}
                  </span>
                  <span>
                    ELITE tier (1600+ score)
                    {score < 1600 && score > 0 && <span className="text-gray-500"> - You have {score}</span>}
                  </span>
                </li>
                <li className="flex items-center gap-2">
            ...
            <TrustGate minScore={1600} userScore={score}>
              <PayButton
                amount={5}
